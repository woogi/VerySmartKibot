...
public class Config {
    ...
    public static final String SAVE_FACES_PATH = SDCARD + "facerecognition/camera/.project/.face/";
    public static final String SAVE_FACES_TRAINING_LIST_PATH = SDCARD + "facerecognition/camera/.project/.training.csv";
    public static final String SAVE_FACES_TRAINING_RESULT_PATH = SDCARD + "facerecognition/camera/.project/.modeldata.dat";
